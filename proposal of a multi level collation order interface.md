...
&#x20;                                               if constexpr(!std::is\_user\_declared < ^ ^ MyClass::reserve > || (std::is\_user\_declared < ^ ^ MyClass::push\_back > || std::is\_user\_declared < ^ ^ MyClass::push\_front > )) {
...
&#x20;                                                       if constexpr(std::is\_user\_declared < ^ ^ MyClass::push\_back > ) {
